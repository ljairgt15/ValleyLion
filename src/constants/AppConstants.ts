export class AppConstants {
    public static readonly CELLPHONE_NUMBER: string ="988928886";
    public static readonly WHATSAPP_URL: string = `https://wa.me/${AppConstants.CELLPHONE_NUMBER}`;
    public static readonly FACEBOOK_URL: string = "https://www.facebook.com/leones.oyambarillo";
